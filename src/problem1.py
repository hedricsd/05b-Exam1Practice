...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         ...
         their colleagues, and Sam Hedrick.
...
def run_test_problem1a():
    ...
    print_expected_result_of_test([1, 10], expected, test_results,
                                  format_string)
    actual = problem1a(1, 10)
    print_actual_result_of_test(expected, actual, test_results, precision=3)

    # Test 4:
    expected = -0.480  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([12, 13], expected, test_results,
                                  format_string)
    actual = problem1a(12, 13)
    print_actual_result_of_test(expected, actual, test_results, precision=3)
